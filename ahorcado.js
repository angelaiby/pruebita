...
function ingresarPalabra(palabra){
  var i =0;
  while(i<10){
    var intentos= prompt("ingrese cada letra de la palabra para no ser ahorcado");
    i++;
  }
}
console.log(ingresarPalabra(palabra));

function DibujarHombre(partes) {
...
console.log(DibujaHombre( partes));
